...
(function (artemis) {
    ...
    (function (blackboard) {
        ...
        })(TriggerStateType = blackboard.TriggerStateType || (blackboard.TriggerStateType = {}));
    ...
    (function (blackboard) {
        ...
        var TriggerMultiCondition = (function (_super) {
            ...
            function TriggerMultiCondition(condition, onFire, names) {
                var _this = _super.call(this, names) || this;
                _this.condition = condition;
                _this.onFire = onFire;
                return _this;
            }
...
(function (artemis) {
    ...
    })(Taxonomy = artemis.Taxonomy || (artemis.Taxonomy = {}));
...
(function (artemis) {
    ...
    var ComponentTypeFactory = (function () {
        ...
        ComponentTypeFactory.prototype.getTypeFor = function (c) {
            if ('number' === typeof c) {
                return this.types[c.toString(10)];
            }
...
(function (artemis) {
    ...
    var ComponentManager = (function (_super) {
        ...
        function ComponentManager() {
            var _this = _super.call(this) || this;
            _this.componentsByType_ = new Bag();
            _this.pooledComponents_ = new ComponentPool();
            _this.deleted_ = new Bag();
            _this.typeFactory = new ComponentTypeFactory();
            return _this;
        }
...
(function (artemis) {
    ...
    var EntityManager = (function (_super) {
        ...
        function EntityManager() {
            var _this = _super.call(this) || this;
            _this.entities_ = new Bag();
            _this.disabled_ = new BitSet();
            _this.identifierPool_ = new IdentifierPool();
            _this.active_ = 0;
            _this.added_ = 0;
            _this.created_ = 0;
            _this.deleted_ = 0;
        ...
        */
        var GroupManager = (function (_super) {
            ...
            function GroupManager() {
                var _this = _super.call(this) || this;
                _this.entitiesByGroup_ = new HashMap();
                _this.groupsByEntity_ = new HashMap();
                return _this;
            }
        ...
        */
        var PlayerManager = (function (_super) {
            ...
            function PlayerManager() {
                var _this = _super.call(this) || this;
                _this.playerByEntity_ = new HashMap();
                _this.entitiesByPlayer_ = new HashMap();
                return _this;
            }
    ...
    (function (managers) {
        ...
        */
        var TagManager = (function (_super) {
            ...
            function TagManager() {
                var _this = _super.call(this) || this;
                _this.entitiesByTag_ = new HashMap();
                _this.tagsByEntity_ = new HashMap();
                return _this;
            }
        ...
        */
        var TeamManager = (function (_super) {
            ...
            function TeamManager() {
                var _this = _super.call(this) || this;
                _this.playersByTeam_ = new HashMap();
                _this.teamByPlayer_ = new HashMap();
                return _this;
            }
        ...
        */
        var VoidEntitySystem = (function (_super) {
            ...
            function VoidEntitySystem() {
                return _super.call(this, Aspect.getEmpty()) || this;
            }
        ...
        */
        var IntervalEntityProcessingSystem = (function (_super) {
            ...
            function IntervalEntityProcessingSystem(aspect, interval) {
                return _super.call(this, aspect, interval) || this;
            }
            /**
            * Process a entity this system is interested in.
            * @param e the entity to process.
